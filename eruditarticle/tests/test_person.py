...
@pytest.mark.parametrize(
    ...
    + [
        ...
        ([("Firstname", "Lastname", "Othername")], "Lastname, Firstname O."),
        ([("Firstname", "Lastname", "Other1 Other2")], "Lastname, Firstname O. O."),
        ([("First1", "Last1"), ("First2", "Last2")], "Last1, First1 et First2 Last2."),
        (
...
@pytest.mark.parametrize(
    ...
    + [
        ...
        ([("Firstname", "Lastname", "Othername")], "Lastname, F. O."),
        ([("Firstname", "Lastname", "Other1 Other2")], "Lastname, F. O. O."),
        ([("First1", "Last1"), ("First2", "Last2")], "Last1, F. & Last2, F."),
        (
            [("First1", "Last1", "Other1"), ("First2", "Last2", "Other2")],
            "Last1, F. O. & Last2, F. O.",
        ),
        ...
        ([("Firstname", None)], "Firstname"),
        ([(None, "Lastname")], "Lastname"),
        ([("Composed-Firstname", "Lastname")], "Lastname, C.-F."),
    ],
)
...
@pytest.mark.parametrize(
    ...
    + [
        ...
        ([("Firstname", "Lastname", "Othername")], "Lastname, Firstname O."),
        ([("Firstname", "Lastname", "Other1 Other2")], "Lastname, Firstname O. O."),
        ([("First1", "Last1"), ("First2", "Last2")], "Last1, First1 et Last2, First2"),
        (
            [("First1", "Last1", "Other1"), ("First2", "Last2", "Other2")],
